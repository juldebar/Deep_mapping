...
COMMENT ON COLUMN "annotation"."photo_id" IS '"bounding_box: in case the location of the object in the image reference system (coordinates of pixels) would be needed." ';

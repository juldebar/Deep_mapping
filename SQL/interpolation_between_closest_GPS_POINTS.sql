SELECT row_number() OVER (ORDER BY photos_exif_core_metadata."FileName") AS OID, photos_exif_core_metadata."FileName",
	CASE 
...
WHERE photos_in_segment > 1 AND photos_in_segment < 3 AND list_photos @> ARRAY[photos_exif_core_metadata."FileName"]
LIMIT 800
;
...
COMMENT ON COLUMN metadata."id_metadata" IS '"id_metadata" is a Serial (integer) used as a primary key to identify each dataset within the database model';

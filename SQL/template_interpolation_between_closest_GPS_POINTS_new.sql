SELECT 
	...
	FROM 
		...
		FROM 
		              ...
		              WHERE  photos.session_id='session_2018_03_24_kite_Le_Morne' 
		              ORDER BY GPS_trackpoint_id, gps_tracks."time"- (photos."DateTimeOriginal" - interval '42 second') ASC LIMIT 2
		              ) AS foo 

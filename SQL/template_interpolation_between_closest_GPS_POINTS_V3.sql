SELECT 
	...
	ST_X(ST_LineInterpolatePoint(segment_wkt, ((unnest(array_positions(list_photos, photos_exif_core_metadata."FileName"))::numeric / (count_photos+1)::numeric)))) AS "decimalLatitude",
	ST_Y(ST_LineInterpolatePoint(segment_wkt, ((unnest(array_positions(list_photos, photos_exif_core_metadata."FileName"))::numeric / (count_photos+1)::numeric)))) AS "decimalLongitude",

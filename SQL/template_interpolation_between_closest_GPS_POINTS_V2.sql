SELECT 
	...
	CONCAT(photos_exif_core_metadata."relative_path"||'/'||photos_exif_core_metadata."FileName") AS file_path, 
		...
		FROM 
			(
				...
				WHERE  GPS2.fid = GPS1.fid +1
				 AND GPS1.session_id=GPS2.session_id AND GPS1.session_id=photos.session_id AND GPS1.session_id='session_2018_08_25_Zanzibar_Snorkelling' 

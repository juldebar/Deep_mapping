...
default_wkt <- "POLYGON ((57.29951 -20.47986, 57.29951 -20.47239, 57.31122 -20.47239, 57.31122 -20.47986, 57.29951 -20.47986))"
layer <- "view_occurences_manual_annotation"
sql_query <- paste0('select * FROM ',layer,' WHERE  geometry_postgis IS NOT NULL AND ST_Within(geometry_postgis,ST_GeomFromText(\'',default_wkt,'\',4326)) LIMIT 300')
...
# saveRDS(data_sf,"./data/reef_images.rds")
